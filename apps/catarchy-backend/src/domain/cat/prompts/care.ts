...
export function buildCarePrompt({
  ...
  return {
    system: `Describe a cat's behavior/Pattern: "[Name] verb object [adverb/adjective phrase]."/Plain text only${personality ? "/Follow the big5 personality traits(100-scale)" : ""}`,
